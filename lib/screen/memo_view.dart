...
class MemoViewScreen extends StatefulWidget {
  const MemoViewScreen({Key? key, required this.memoId}) : super(key: key);

  final int memoId;

  @override
  State<StatefulWidget> createState() => _MemoViewScreenState(memoId);
}

class _MemoViewScreenState extends State<MemoViewScreen> {
  _MemoViewScreenState(this.memoId);
